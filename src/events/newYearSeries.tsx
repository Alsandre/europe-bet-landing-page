  ...
  return (
    <>
      <PrimaryCard className='mb-2'>
        ...
        <DailyShedule />
        <p className='text-center my-3 text-14'>* ყველა ტურნირზე მოხვედრა შესაძლებელია 0 ლარიდან.</p>
        <p className='text-center text-14'>ტურნირების სრული განრიგის სანახავად გადადი პოკერის ლობიში</p>
        <button className='block w-36 h-8 rounded-[5px] bg-orange-22 py-[6px] px-[18px] m-auto mt-4 mb-5 text-14'>პოკერის ლობი</button>
      </PrimaryCard>
      <PrimaryCard>
      ...
      <div>
        <h5 className='font-bold text-12 mt-6 mb-5 w-mobile m-auto'>ყოველდღიური ტურნირები და სატელიტები</h5>
        <SpecialEvent title='Omaha Highrollers' prize={40000} buyIn='XXX' date={new Date(2023, 11, 27)} backgroundImg={specialEvent1} />
        <SpecialEvent title='Omaha Highrollers' prize={40000} buyIn='XXX' date={new Date(2023, 11, 27)} backgroundImg={specialEvent1} />
        <SpecialEvent title='Omaha Highrollers' prize={40000} buyIn='XXX' date={new Date(2023, 11, 27)} backgroundImg={specialEvent} />
        <p className='font-medium text-12 w-mobile m-auto'>* სამივე ტურნირის გამარჯვებულები მიიღებენ ბეჭდებს და ფინალურ ეტაპზე, The Lord of the Rings ტურნირზე, იბრძოლებენ The Festival in Malta-ს საგზურის მისაღებად.</p>
      </div>
